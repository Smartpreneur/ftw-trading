...
export function StartContent({ isAuthed }: { isAuthed: boolean }) {
  ...
  return (
    <div className="space-y-10">
      ...
      {!isAuthed && (
        <div className="pt-4 border-t border-border">
          <a
            href="https://premium.finanzmarktwelt.de/s/finanzmarktwelt/sign_in"
            ...
            style={{ background: `linear-gradient(135deg, ${FMW.primary}, ${FMW.light})` }}
          >
            ...
            Zum Mitgliederbereich anmelden
          </a>
        </div>
      )}
