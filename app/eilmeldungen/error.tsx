...
export default function EilmeldungenError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('EilmeldungenPage render error:', error)
  }, [error])
    ...
    <div className="py-16">
      <div className="mx-auto max-w-lg rounded-lg border border-amber-200 bg-amber-50 p-6 text-center">
        ...
        <p className="mb-4 text-sm text-amber-800">
          Die Eilmeldungs-Übersicht ist gerade nicht verfügbar. Versuche es bitte in einem
          Moment erneut.
        </p>
        {error.digest && (
