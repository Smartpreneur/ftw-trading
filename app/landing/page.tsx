  ...
  return (
    <>
      ...
      <section className="section section--alt">
        <div className="container">
          ...
          <p className="results-note">
            Mit Hebelpapieren vervielfacht sich der Erfolg.
          </p>
        ...
        <div className="container">
          ...
          <div className="team-grid">
            <div className="team-card reveal">
              <div className="team-card__avatar">MB</div>
            ...
            <div className="team-card reveal">
              <div className="team-card__avatar">SJ</div>
              <h3>Stefan Jäger</h3>
      ...
      <section className="section section--alt" id="pricing">
        <div className="container">
          <h2 className="text-center reveal">Ab 1,18 € pro Börsentag</h2>
          <p className="subtitle text-center reveal">
          ...
          <div className="pricing-grid">
            ...
            <div className="pricing-card reveal">
              <div className="pricing-card__period">Monatsabo</div>
              <div className="pricing-card__price">
                49 € <span>/ Monat</span>
              </div>
              <div className="pricing-card__detail">Monatlich kündbar</div>
              <ul className="pricing-card__features">
                <li>4–6 Setups pro Woche</li>
                <li>Wöchentliches Analyse-Video</li>
                <li>Eil-Benachrichtigungen</li>
              </ul>
            ...
            <div className="pricing-card pricing-card--featured reveal">
              <div className="pricing-card__label">Beliebteste Wahl</div>
              <div className="pricing-card__period">Halbjahresabo</div>
              <div className="pricing-card__price">
                39 € <span>/ Monat</span>
              </div>
              <div className="pricing-card__detail">
                234 € alle 6 Monate – spare 20 %
              </div>
              <ul className="pricing-card__features">
                <li>Alles aus dem Monatsabo</li>
                <li>Direkter Rückkanal zur Redaktion</li>
                <li>20 % Ersparnis</li>
              </ul>
            ...
            <div className="pricing-card reveal">
              ...
              <div className="pricing-card__detail">
                348 € pro Jahr – spare 40 %
              </div>
              <ul className="pricing-card__features">
                <li>Alles aus dem Halbjahresabo</li>
                <li>Bester Preis pro Analyse</li>
                <li>40 % Ersparnis</li>
              </ul>
              <a href="#" className="cta-btn cta-btn--ghost cta-btn--full">
                Jetzt starten
              ...
              <div className="faq-answer">
                <div className="faq-answer__inner">
                  <p>
                    ...
                    pro Jahr. Fugmanns Trading Service ist ab 348 € / Jahr
              ...
              <div className="faq-answer">
                <div className="faq-answer__inner">
                  <p>
                    ...
                    Laufzeit kündigen. Beim Monatsabo sogar monatlich.
                  </p>
                </div>
              </div>
            </div>
